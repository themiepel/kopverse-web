...
<div class="min-h-screen bg-gradient-to-br from-green-50 via-green-100 to-yellow-50 flex justify-center items-center">
    ...
    <div id="splash-screen" class="w-full max-w-[430px] h-screen md:h-[85vh] bg-cover bg-center md:rounded-[32px] md:shadow-2xl overflow-hidden relative flex flex-col justify-between p-8 select-none animate-fade-in"
        ...
        <div class="flex-1 flex items-center justify-center pt-20">
            <img
                src="{{ Vite::asset('resources/images/logo/kopverse_logo.png') }}"
                alt="KOPVERSE"
                class="w-72 drop-shadow-[0_4px_8px_rgba(0,0,0,0.3)]">
        </div>

        <div class="w-full space-y-3 pb-12 px-4">
            <div class="flex justify-between items-center text-[#FFF8F0] font-game tracking-[1.4px] text-[10px] uppercase">
                <div class="flex items-center gap-1.5 drop-shadow-[0_1.5px_2px_rgba(0,0,0,0.6)]">
                    <svg class="animate-spin h-3 w-3 text-[#FFF8F0]" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            ...
            <div class="w-full h-8 bg-[#5D3E24] border-3 border-[#A36A3B] rounded-full p-[3px] progress-container-shadow flex items-center">
                <div id="progress-bar"
