...
<div class="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 flex justify-center items-center">
    ...
    <div class="w-full max-w-[430px] h-screen md:h-[85vh] bg-repeat overflow-y-auto relative flex flex-col p-4 select-none animate-fade-in"
        ...
        <div class="w-full bg-[#855300] bg-blend-screen rounded-[32px] border-4 border-[#49220E] shadow-[0_6px_0_0_#472211] p-4 mt-16 flex-1 flex flex-col justify-start space-y-4 relative"
            ...
            <div class="quest-title absolute -top-6 left-1/2 -translate-x-1/2 w-[220px] h-[52px] flex justify-center items-center rounded-[10px] border-4 border-[#3B4E7D] bg-gradient-to-b from-[#869EED] to-[#5789FF] shadow-[0_4px_0_0_#3B4E7D]">
                <span class="font-game text-[24px] text-white text-stroke-thick tracking-wide whitespace-nowrap uppercase">
                    MY BAKERY
                </span>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4 pt-4">
                ...
                <button onclick="window.location.href='/bakery/inventory'"
                    ...
                    <img src="{{ Vite::asset('resources/images/ui/inventory_icon.png') }}" alt="Inventory" class="w-20 h-16 object-contain">
                    <span class="font-game text-[18px] text-white text-stroke-game uppercase tracking-wide">Inventory</span>
                </button>

                <button onclick="window.location.href='/bakery/production'"
                        class="h-[140px] rounded-[29px] border-2 border-[#784226] bg-[#C87920] btn-kdmp-orange-shadow p-3 flex flex-col items-center justify-center gap-1 transition-all btn-game-active cursor-pointer">
                    <img src="{{ Vite::asset('resources/images/ui/production_icon.png') }}" alt="Production" class="w-20 h-16 object-contain">
                    <span class="font-game text-[18px] text-white text-stroke-game uppercase tracking-wide">Production</span>
                </button>

            </div>


            <div class="w-full h-[135px] rounded-[29px] border-2 border-[#784226] bg-[#F2E6D9] btn-kdmp-cream-shadow p-4 flex items-center justify-between relative overflow-hidden mt-2">

                <div class="flex items-center">
                    <img src="{{ Vite::asset('resources/images/ui/serve_illustration.png') }}" alt="Serve Customer" class="w-32 h-24 object-contain">
                </div>

                <button onclick="window.location.href='/bakery/serve'"
